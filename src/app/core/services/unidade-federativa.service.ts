...
export class UnidadeFederativaService {
  ...
  listar(): Observable<UnidadeFederativa[]> {
    /**
     * shareReplay é um operador RxJS que, ao ser combinado com o método pipe,
     * nos permite armazenar em cache o resultado de um Observable.
     * Isso nos permite fazer exatamente o que queremos aqui: evitar requisições HTTP desnecessárias.
     */
    if (!this.cache$) {
